...
RUN groupadd -g 1000 aa35037123
# password = sense
RUN useradd --uid 1000 --gid 1000 --groups root,sudo,adm,users --create-home --password "`openssl passwd -6 -salt XX sense`" --shell /bin/bash aa35037123
